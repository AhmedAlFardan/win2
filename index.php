...
<?php include_once './parts/header.php';   ?>
    ...
    <img src="images/1.jpg"  width="300" height="185" alt="" >    
    <h1 class="display-4 fw-normal">أربح مع أحمد</h1>
    ...
    <ul class="list-group list-group-flush">
        ...
        <li class="list-group-item">الرابح سيحصل على نسخة مجانية من برنامج كاماتازيا</li>
    </ul>
    </div>
    </div>
